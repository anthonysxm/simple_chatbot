...
...
```
In this app, you can explore the outputs of a LLM.
"""
...
with gr.Blocks(css = """#col_container { margin-left: auto; margin-right: auto;}
              ...
              theme=theme) as demo:
    gr.HTML(title)
    gr.HTML("""<h3 align="center">This app provides you full access to LLM. You don't need any OPENAI API key.<br><br>If this app doesn't respond, it's likely due to too much visitors.</h3>""")
